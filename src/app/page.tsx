...
export default function HomePage() {
  ...
  const MobileSidebar = () => (
    <aside
      id="salones-mobile"
      className={`fixed inset-y-0 left-0 z-50 w-96 bg-white border-r border-warm-steel/20 transform transition-transform duration-300 lg:hidden ${
        isMobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
      aria-label="Lista de salones"
    >
      <div className="flex flex-col h-full">
        <div className="p-4 border-b border-warm-steel/20 flex items-center justify-between">
        ...
        <div className="p-4 border-b border-warm-steel/20">
        ...
        <div className="p-4 border-t border-warm-steel/20">
          <Link
            href="/salones"
  ...
  const MobileSidebarTrigger = () => (
    <button
      className="lg:hidden fixed top-20 left-4 z-30 p-2 bg-white rounded-lg shadow-lg border border-warm-steel/20"
  ...
  const DesktopLayout = () => (
    <div className="hidden lg:flex lg:flex-row h-[calc(100vh-4rem)]">
      {/* Sidebar Desktop - siempre visible */}
      <aside
        id="salones-desktop"
        className="w-96 flex-shrink-0 border-r border-warm-steel/20 bg-white h-full"
        aria-label="Lista de salones"
      >
        <div className="flex flex-col h-full">
          <div className="p-4 border-b border-warm-steel/20">
      ...
      <div className="flex-1 relative min-w-0">
        ...
        {selectedSalon && (
          <div className="absolute bottom-8 right-8 z-20 animate-slide-up">
            <Link
  ...
  // ====== LAYOUT MÓVIL: Mapa a ancho completo ======
  const MobileLayout = () => (
    <section className="lg:hidden relative h-[50vh]">
      <Suspense fallback={<div className="h-full w-full bg-surface-light flex items-center justify-center"><div className="w-8 h-8 border-4 border-accent border-t-transparent rounded-full animate-spin" aria-hidden="true" /></div>}>
        <MapaSalones
          salones={mockSalones}
          selectedSalon={selectedSalon}
  ...
  // ====== CONTENIDO COMÚN (debajo del mapa) ======
  const CommonContent = () => (
    <div className="max-w-7xl mx-auto px-4 w-full">
      ...
      <section className="py-16 lg:py-24 bg-concrete text-white">
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 relative">
        {/* Móvil: overlay + sidebar drawer + trigger + mapa */}
        {isMobileSidebarOpen && <MobileOverlay />}
        <MobileSidebar />
        <MobileSidebarTrigger />
        <MobileLayout />

        {/* Desktop: sidebar fijo + mapa */}
        <DesktopLayout />

        {/* Contenido común centrado */}
        <CommonContent />
      </main>
